                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h1>{{ number_format($data['value']['project'] + $data['value']['in_house'] + $data['value']['public_training']) }}</h1>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
    ...
    <div class="card-top p-3">
        <div class="row">
            <div class="col-md-6 d-flex" style="  align-items: center;">
                ...
                <span class="badge badge-pill rounded badge-dark text-white pt-2">20</span>
