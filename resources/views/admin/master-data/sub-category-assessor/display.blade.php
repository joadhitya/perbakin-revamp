<table class="table datatables table-bordered table-hover table-data" id="table-sub-category-assessor">
    <thead>
                ...
                <td class="w-5p">
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn p5x btn-sm btn-outline-warning"
                            onclick="openModal('sub-category-assessor','edit', {{ $item->id }})"><span
