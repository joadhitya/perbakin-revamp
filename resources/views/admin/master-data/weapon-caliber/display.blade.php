<table class="table datatables table-bordered table-hover table-data" id="table-md-weapon-caliber">
    <thead>
        <tr class="text-uppercase">
            <th class="w-5p">No</th>
            <th>Kode</th>
            <th>Nama Kaliber Senjata</th>
                ...
                <td class="w-5p">
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn p5x btn-sm btn-outline-warning"
                            onclick="openModal('md-weapon-caliber','edit', {{ $item->id }})"><span
