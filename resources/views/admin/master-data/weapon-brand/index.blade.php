...
@section('title', 'Master Data Merk Senjata')
@section('content')
    <div class="col-md-12 ">
            ...
            <div class="card-header">
                <div class="toolbar row ">
                    <div class="col-md-6 col-sm-6 col-6">
                        <h5 class="h5 text-uppercase">List Merk Senjata</h5>
                    </div>
                    <div class="col-md-6 col-sm-6 col-6">
                        <button type="button" class="btn btn-sm btn-primary mr-1 float-right text-uppercase"
                            onclick="openModal('md-weapon-brand','add')"><i class="fe fe-plus"></i> Tambah Data</button>
                    </div>
                </div>
            </div>

            <div class="card-body pt-2" id="show-data-md-weapon-brand">
...
@section('modal')
    @include('admin.master-data.weapon-brand.modal')
@endsection
