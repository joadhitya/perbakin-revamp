            ...
            <div class="card-header">
                <div class="toolbar row ">
                    <div class="col-md-6 col-sm-6 col-6">
                        <h5 class="h5 text-uppercase">List Master Status</h5>
                    </div>
                    <div class="col-md-6 col-sm-6 col-6">
                        <button type="button" class="btn btn-sm btn-primary mr-1 float-right text-uppercase"
                            onclick="openModal('status','add')"><i class="fe fe-plus"></i> Create Data</button>
                    </div>
                </div>
            </div>

            <div class="card-body pt-2" id="show-data-status">
...
@section('modal')
    @include('admin.master-data.status.modal')
@endsection
