<table class="table datatables table-bordered table-hover table-data" id="table-sub-category-booklet">
    <thead>
                ...
                <td class="w-5p">
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn p5x btn-sm btn-outline-warning"
                            onclick="openModal('sub-category-booklet','edit', {{ $item->id }})"><span
