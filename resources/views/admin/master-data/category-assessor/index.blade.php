...
@section('title', 'Master Data Kategori Assessor')
@section('content')
    <div class="col-md-12 ">
            ...
            <div class="card-header">
                <div class="toolbar row ">
                    <div class="col-md-6 col-sm-6 col-6">
                        <h5 class="h5 text-uppercase">List Assessor Kategori</h5>
                    </div>
                    <div class="col-md-6 col-sm-6 col-6">
                        <button type="button" class="btn btn-sm btn-primary mr-1 float-right text-uppercase"
                            onclick="openModal('category-assessor','add')"><i class="fe fe-plus"></i> Tambah Data</button>
                    </div>
                </div>
            </div>

            <div class="card-body pt-2" id="show-data-category-assessor">
...
@section('modal')
    @include('admin.master-data.category-assessor.modal')
@endsection
