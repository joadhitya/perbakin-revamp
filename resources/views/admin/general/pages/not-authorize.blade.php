...
<head>
    ...
    <title>PERBAKIN Jawa Tengah - Not Authorized</title>
    ...
    <div class="wrapper vh-100">
        <div class="align-items-center h-100 d-flex w-50 mx-auto">
            <div class="mx-auto text-center">
                ...
                <h6 class="mb-3 text-muted">You are not Authorized on this page</h6>
                <a href="{{ route('dashboard') }}" class="btn btn-lg btn-primary px-5">Back to Dashboard</a>
            </div>
        </div>
    </div>
</body>
