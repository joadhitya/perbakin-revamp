<ul class="navbar-nav flex-fill w-100 mb-2">
    ...
    {{-- <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'parking-consultant') active-label @endif"
            href="{{ route('parking-consultant.index') }}">
            <i class="fe fe-users fe-16"></i>
            <span class="ml-3 item-text">Parking</span>
        </a>
    </li> --}}
    {{-- <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'reporting-consultant') active-label @endif"
            href="{{ route('reporting-consultant.index') }}">
            <i class="fe fe-file-text fe-16"></i>
            <span class="ml-3 item-text">Reporting</span>
        </a>
    </li>
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'availability-consultant') active-label @endif"
            href="{{ route('availability-consultant.index') }}">
            <i class="fe fe-user-check fe-16"></i>
            <span class="ml-3 item-text">Availability Consultant</span>
        </a>
    </li> --}}
</ul>
...
{{-- <ul class="navbar-nav flex-fill w-100 mb-2">
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'project-assign-consultant') active-label @endif" href="{{ route('project-assign-consultant.index') }}">
            <i class="fe fe-send fe-16"></i>
            <span class="ml-3 item-text">Project Assign</span>
        </a>
    </li>
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'chargeable-consultant') active-label @endif"
            href="{{ route('chargeable-consultant.index') }}">
            <i class="fe fe-dollar-sign fe-16"></i>
            <span class="ml-3 item-text">Chargable Rate</span>
        </a>
    </li>
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'project-status-consultant') active-label @endif"
            ...
            <span class="ml-3 item-text">Project Training Status</span>
        </a>
    </li>
</ul> --}}
<ul class="navbar-nav flex-fill w-100 mb-2">
    ...
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'assign-staff') active-label @endif"
            href="{{ route('assign-staff.index') }}">
            <i class="fe fe-users fe-16"></i>
            <span class="ml-3 item-text">Assign Staff</span>
        </a>
    </li>
    <li class="nav-item w-100">
    ...
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'manage-invoice') active-label @endif"
            href="{{ route('manage-invoice.index') }}">
            <i class="fe fe-file-text fe-16"></i>
            <span class="ml-3 item-text">Manage Invoice</span>
        </a>
    </li>
    ...
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(4) == 'approve-consultant') active-label @endif"
            href="{{ route('approve-consultant.index') }}">
            <i class="fe fe-check-circle fe-16"></i>
            <span class="ml-3 item-text">Approve Consultant's</span>
        </a>
    </li>
</ul>
...
<ul class="navbar-nav flex-fill w-100 mb-2">
    ...
    <li class="nav-item w-100">
        <a class="nav-link @if (Request::segment(3) == 'holiday') active-label @endif"
            href="{{ route('holiday.index') }}">
            <i class="fe fe-coffee fe-16"></i>
            <span class="ml-3 item-text">Setting Holiday</span>
        </a>
    </li>
</ul>
